...
public class MoLiService {
    ...
    public String getJokeMessage() {
        ...
        AsyncManager.me().execute(AsyncFactory.sendResponse("joke", jokeJson));
    ...
    public String getGylqMessage() {
        ...
        AsyncManager.me().execute(AsyncFactory.sendResponse("gylq", gylqJson));
    ...
    public String getYllqMessage() {
        ...
        AsyncManager.me().execute(AsyncFactory.sendResponse("yllq", yllqJson));
    ...
    public String getCsylqMessage() {
        ...
        AsyncManager.me().execute(AsyncFactory.sendResponse("csylq", csylqJson));
